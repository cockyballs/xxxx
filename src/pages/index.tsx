...
const Home = () => {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('contact@kharoxe.wtf')
    theme === 'dark'
  ...
  return (
    <>
      <a rel="me" href="https://social.zyno.us/@kharoxe" style={{"display": "none"}}></a>
      <GenericMeta title="Kharoxe" description="Junior Penetration Tester." />

      <MainLayout margin={false}>
        <h1 className="text-6xl font-bold">Kharoxe</h1>
